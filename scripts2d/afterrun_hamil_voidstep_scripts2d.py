...
from tools.afterrun_hamiltonians import ExeTaurus2D_AfterRun_HamilDecomposition 


def run_b20_decomposeHamiltonian_GognyB1_2d(nuclei, constraints=['',], 
                                            fomenko_points=(1, 1),):
    """
    ...
    for zn, inter in nuclei.items():
        ExeTaurus2D_AfterRun_HamilDecomposition.HAMIL_NAME = GognyEnum.B1
        
        exe_ = ExeTaurus2D_AfterRun_HamilDecomposition(*zn, inter, MAIN_FLD)
