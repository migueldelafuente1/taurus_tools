...
from _legacy.exe_q20pes_taurus import TemplateDDInp, template_DD_input, zipBUresults
from _legacy.exe_q20pes_taurus import _setDDTermInput, _printInput4Calculation  # _exportResult (overwriten)
import math as mth
...
Constraint multipole Q21      0   0.000
...
def mainLinuxFixedStep_Bfixed(z, n, interaction, pair_constr, 
    ...
    if seed_ == 1:
        ...
        order_ = 'cp seedsMZ4/final_z{}n{}.bin initial_wf.bin'.format(z,n)
    ...
    _default_grad = {Template.eta_grad: 0.06,
    ...
    for i_deform, deform in enumerate((deform_oblate, deform_prolate)):             
        ...
        for pc_val in deform:
            ...
            for iter_ in range(1, 4): # repeat if not converges
                ...
                if (res != None) and res_0.properly_finished:
                    # _e = subprocess.call()
                    break
                else:
                    if iter_ == 3:
    ...
    if not os.getcwd().startswith('C:'):    #
        ...
        for z, n in nucleus:
            ...
            mainLinuxFixedStep_Bfixed(z, n, interaction, PAIR_CONSTR,
                                      p_min=-1.5, p_max=1.5, N_max=20, # 25 
                                      seed_=1, dd=False)
            
            # export the back up results into a zip folder.
            zipBUresults(z,n,interaction,'B20',PAIR_CONSTR)
        ...
        if True:
            ...
            # z, n = z - 8, n - 8
            # PESfolder = 'PN_mixingD1STests/KB3G/PS_surf_Fe/'
            # z, n = z - 20, n - 20
            files_ = [
                Template.P_T00_J10, 
                Template.P_T1p1_J00, 
